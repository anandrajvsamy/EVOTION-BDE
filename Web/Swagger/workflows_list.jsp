...
dawId=$("#dawId").val();
var url="./api/workflows/list";
if(dawId!=''){
	url="./api/workflows/findByModel/"+dawId;
}
$.ajax({
	  url: url,
	  cache: false,
...
$( document ).ready(function() {
	...
	$("#searchWorkflowsButton").on("click", function (e) {
...
<div class="container-fluid" id="contenitore">
    <div class="row">
        <div class="col-md-2" id="logo"><a href="workflows_list.jsp"><img src="images/logo_interno.png" alt="Evotion" /></a></div>
    ...
    <div class="row">
        ...
        <div class="col-md-10" id="contenitore_centrale">
        	<h1>Workflows Catalogue</h1>
            <div class="row">
                <div class="col-md-12"><button type="button" class="btn btn-success pull-right" id="bottone_inserisci" onclick="return addWorkflow();"><span class="glyphicon glyphicon-asterisk " aria-hidden="true"></span> ADD WORKFLOW</button></div>
            </div>
            <br />
            ...
            <div class="contenitore_filtri">
            	<form class="form-inline" action="" method="post">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="DAW ID" name="dawId" id="dawId" value=""/>
                  </div>
                  <div class="form-group">
                 	 <button type="button" class="btn btn-primary" name="searchWorkflowsButton" id="searchWorkflowsButton"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> SEARCH</button>
                 </div>
                </form>
            </div>
            <br />
